// --- FINAL, ENHANCED, AND FILTERABLE BLOCK EXPLORER SCRIPT ---
...
const webSocketRpcUrl = "YOUR_INFURA_OR_ALCHEMY_WEBSOCKET_URL"; // <-- PASTE WSS URL
    // --- IMPORTANT: PASTE YOUR SEPOLIA RPC URL HERE ---
    ...
    // --- NEW: Renders blocks in the green card style ---
    const renderBlock = (block) => {
        ...
        blockDiv.innerHTML = `
            ...
            <div class="block-field">
                <span class="field-label">Merkle Root (transactionsRoot):</span>
